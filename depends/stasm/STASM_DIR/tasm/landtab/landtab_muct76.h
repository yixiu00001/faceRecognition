// landtab_muct76.h: definitions for MUCT 76 point shapes
//
// Copyright (C) 2005-2013, Stephen Milborrow

#ifndef STASM_LANDTAB_MUCT76_H
#define STASM_LANDTAB_MUCT76_H

// Note that the AT_Hat bit is ignored if pyr lev > HAT_START_LEV

static const LANDMARK_INFO LANDMARK_INFO_TAB[76] = // 76 points
{
//   par pre next weight bits
    ...
    { -1, 27, 28,  1., AT_Glasses|AT_Eye|AT_Hat }, // 68 LEye68
    { -1, 28, 29,  1., AT_Glasses|AT_Eye|AT_Hat }, // 69 LEye69
    { -1, 29, 30,  1., AT_Glasses|AT_Eye|AT_Hat }, // 70 LEye70
    { -1, 27, 30,  1., AT_Glasses|AT_Eye|AT_Hat }, // 71 LEye71
    { -1, 32, 33,  1., AT_Glasses|AT_Eye|AT_Hat }, // 72 REye72
    { -1, 33, 34,  1., AT_Glasses|AT_Eye|AT_Hat }, // 73 REye73
    { -1, 34, 35,  1., AT_Glasses|AT_Eye|AT_Hat }, // 74 REye74
    { -1, 32, 35,  1., AT_Glasses|AT_Eye|AT_Hat }, // 75 REye75
};

#endif // STASM_LANDTAB_MUCT76_H
